With things set in place currently working on python watchdog to precache created files over 1MB. This as well
new alarm clock themes are in the works <br><br>
