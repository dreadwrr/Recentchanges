...
from in Kleopatra - Tools - Restart Background Processes <br>
or <br>
from powershell: <br>
...
Note: Some image paths wont load correctly because of how it would be structured. So the next update will fix this for --standalone. <br><br>
