# Recentchanges
To see ansi colors in powershell run this command <br>
$Host.UI.SupportsVirtualTerminal <br><br>
...
The application works with MFTCmd official\standard of the MFTECmd cutoff version if placed in \bin <br>br<>
